...
/**
 * ------
 * BGA shadowgambit.action.php for Shadow Gambit
 * ------
 */

class action_shadowgambit extends APP_GameAction
{ 
    public function __default()
    {
        if( self::isAjax() )
        {
            ...
            $this->view = "shadowgambit_shadowgambit";
            self::trace( "action_shadowgambit __default gameaction: ".$gameaction );
        }
    }
