/**
 * ------
 * BGA shadowgambit.js for Shadow Gambit
 * ------
 */
...
function (dojo, declare) {
    return declare("bgagame.shadowgambit", ebg.core.gamegui, {
        constructor: function(){
            console.log('shadowgambit constructor');
        ...
        selectChoiceOnServer: function(type, index, choice) {
            this.ajaxcall("/shadowgambit/shadowgambit/playCard.html", {
                type: type,
                index: index,
                choice: choice
        ...
        confirmDeploymentOnServer: function() {
            this.ajaxcall("/shadowgambit/shadowgambit/confirmDeployment.html", {}, this, function(result){});
        },
